...
//i = b; // boolean の値を int に代入
i = by; // byte の値を int に代入
i = s; // short の値を int に代入
i = i; // int の値を int に代入
//i = l; // long の値を int に代入
//i = f; // float の値を int に代入
//i = d; // double の値を int に代入
i = c; // char の値を int に代入
//l = b; // boolean の値を long に代入
l = by; // byte の値を long に代入
l = s; // short の値を long に代入
